...
import sg.nus.iss.ft6.domain.ProductReg;
import sg.nus.iss.ft6.domain.Store;
import sg.nus.iss.ft6.gui.StoreApplication;
...
public class ProductDao extends BaseDao{
	...
	public ArrayList<Product> readProductsFromFile() throws IOException{
		...
		for(int i=0;i<readString.size();i++){
			...
			Category category=store.getCategoryReg().getCategoryByCode(categoryCode);
